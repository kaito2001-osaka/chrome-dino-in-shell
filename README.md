...
| `1`    | Could not start: not a terminal, the window is too small, or a sprite does not match its size constants |
...
| File         | Description                                              |
| ------------ | -------------------------------------------------------- |
| `dino.h`     | Declarations: the sprites and their size constants, terminal helpers, `Game` class |
| `dino.cpp`   | Implementation of the terminal helpers and game logic, plus the sprite art and the startup check that it matches those constants |
